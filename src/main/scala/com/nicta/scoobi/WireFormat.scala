...
object WireFormat {
   ...
   * Catch-all
   */
  @deprecated("Not actually deprecated, but you are using inefficient serialization. See WireFormat.mkCaseWireFormat to define an efficient serialization format.", "since 0.1")
